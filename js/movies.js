...
let movieList = getObj("https://yts.mx/api/v2/list_movies.json?");
...
//let movieRate = movieList.data.movies;
//movieRate.sort((a, b) => parseFloat(b.rating) - parseFloat(a.rating));
